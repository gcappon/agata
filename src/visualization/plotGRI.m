...
% ---------------------------------------------------------------------
    ...
    for gp = 1:length(glucoseProfiles)
        ...
        low = timeInHypoglycemia(glucoseProfiles{gp}) - vlow; % Low (54–<70 mg/dL; 3.0–< 3.9 mmol/L)
        vhigh = timeInSevereHyperglycemia(glucoseProfiles{gp}); % VHigh (>250 mg/dL; > 13.9 mmol/L)
        high = timeInHyperglycemia(glucoseProfiles{gp}) - vhigh; % High (>180–250 mg/dL; >10.0–13.9 mmol/L)
